...
// 获取最佳匹配订单
export const otcGetBestPrice = (data: params) => getGolang('/otc/order/best-price', data);
// 获取最佳匹配订单
export const otcOrderMatch = (data: params) => getGolang('/otc/order/match', data);
// 获取广告信息
...
// 提交lv3认证
export const postVerLv3 = (data: params, config: any) => postGolang('/verification/lv3/submit', data, config);
// 版本更新
...
// 获取指定币种信息
export const getWithdraw = (data: params) => getGolang(`/withdraw/meta/${data.coin}`, data);
// 获取指定币种已转出数量
