...
export default new Vuex.Store({
    ...
    state: {
        lang,
        loading: false,
        showTopBar: !!Number(sessionStorage.getItem('showTopBar')), // 是否头部展示导航栏
        symbol, // 主页当前币种
        unit: 'USD', // 计价单位
        unitIcon: '$', // 计价单位符号
    ...
    mutations: {
        ...
        changeShowTopBar(state, show) {
            ...
            sessionStorage.setItem('showTopBar', `${Number(show)}`);
        },
        /**
        ...
        reSetUserState(state) {
            ...
            state.merchant = {};
            state.country = defaultCountry(); // 国家/地区 区号
            [state.countryType] = CountryType; // 国家/地区类型
